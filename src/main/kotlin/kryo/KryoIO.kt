...
// */
val kryoAndroid get(): Kryo = Kryo(AndroidKotlinResolver(), MapReferenceResolver()).apply {
...
fun Kryo.registerAndroidSerializers() {
    instantiatorStrategy = KotlinObjectInstantiatorStrategy(DefaultInstantiatorStrategy(StdInstantiatorStrategy()))
